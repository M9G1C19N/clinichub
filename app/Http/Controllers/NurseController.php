...
class NurseController extends Controller
{
    ...
    public function vitals(PatientVisit $visit)
    {
        ...
        return inertia('Nurse/Vitals', [
            ...
            'vitals' => $existing ? [
                ...
                'surgical_history_detail' => $existing->surgical_history_detail,
                'allergies_flags'         => $existing->allergies_flags ?? [],
                'allergies_others'        => $existing->allergies_others,
                'menstrual_cycle'         => $existing->menstrual_cycle,
                'lmp'                     => $existing->lmp,
    ...
    public function storeVitals(Request $request, PatientVisit $visit)
    {
        $validated = $request->validate([
            ...
            'surgical_history_detail'  => ['nullable', 'string', 'max:255'],
            'allergies_flags'          => ['nullable', 'array'],
            'allergies_others'         => ['nullable', 'string', 'max:100'],
            'menstrual_cycle'          => ['nullable', 'in:regular,irregular,menopause,postmenopausal'],
            'lmp'                      => ['nullable', 'string', 'max:50'],
