        ...
        try {
            ...
            return redirect()
                ...
                ->with('newTicket', [
                    ...
                    'age_sex'          => $ticket->patient->age_sex,
                    'date_of_birth'    => $ticket->patient->date_of_birth?->format('m/d/Y'),
                    'sex'              => $ticket->patient->sex,
                    'civil_status'     => $ticket->patient->civil_status,
    ...
    public function show(Invoice $invoice)
    {
        ...
        return inertia('Reception/Show', [
            ...
            'ticket' => $invoice->visit->queueTicket ? [
                ...
                'patient_code'     => $invoice->patient->patient_code,
                'age_sex'          => $invoice->patient->age_sex,
                'date_of_birth'    => $invoice->patient->date_of_birth?->format('m/d/Y'),
                'sex'              => $invoice->patient->sex,
                'civil_status'     => $invoice->patient->civil_status,
