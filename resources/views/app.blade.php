...
<head>
    ...
    <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('images/spdl-logo.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('images/spdl-logo.png') }}">
    ...
    <meta property="og:image" content="{{ asset('images/spdl-logo.png') }}">
    ...
    <meta name="twitter:image" content="{{ asset('images/spdl-logo.png') }}">
