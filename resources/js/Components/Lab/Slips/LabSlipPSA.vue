...
<template>
    <div style="font-family:Arial,sans-serif;font-size:12px;color:#111;background:white;
        ...
        <table style="width:100%;border-collapse:collapse;font-size:11px;margin-top:14px;margin-bottom:8px;align-self:start;">
            <thead>
                <tr>
                    <th style="text-align:left;padding:5px 7px;border-bottom:1.5px solid #111;font-size:10.5px;width:50%;">EXAMINATION</th>
                    <th style="text-align:left;padding:5px 7px;border-bottom:1.5px solid #111;font-size:10.5px;width:25%;">RESULT</th>
                    <th style="text-align:left;padding:5px 7px;border-bottom:1.5px solid #111;font-size:10.5px;width:25%;">REFERENCE RANGE</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td style="padding:18px 7px;border-bottom:1px solid #e5e5e5;font-size:12px;">Prostatic Specific Antigen (PSA)</td>
                    <td style="padding:18px 7px;border-bottom:1px solid #e5e5e5;font-size:14px;" :style="rs('PSA')">{{ r('PSA') }}</td>
                    <td style="padding:18px 7px;border-bottom:1px solid #e5e5e5;font-size:10.5px;color:#444;">0 - 4 ng/mL</td>
                </tr>
            </tbody>
        </table>
