...
<div style="width:210mm;height:297mm;padding:6mm 7mm 8mm;box-sizing:border-box;position:relative;overflow:hidden;">
    ...
    <!-- PATIENT INFO -->
    <table style="width:100%;border-collapse:collapse;font-size:9px;margin-bottom:3px;">
        <tr>
    ...
    <div style="font-weight:900;font-size:10px;margin-bottom:2px;">I. MEDICAL HISTORY</div>
    ...
    <div style="margin-bottom:3px;">
        <div style="font-weight:700;font-size:9px;margin-bottom:1.5px;">B. PAST ILLNESSES/HOSPITALIZATIONS</div>
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:0 6px;">
            <div v-for="(col, ci) in illnessCols" :key="ci">
                <div v-for="ill in col" :key="ill.key"
                    style="display:flex;align-items:center;gap:3px;margin-bottom:2.5px;font-size:8.5px;">
        ...
        <div style="font-size:8.5px;margin-top:1.5px;"><strong>Remarks: </strong>{{ vitals?.past_illnesses_remarks || '' }}</div>
    </div>

    <!-- C D E -->
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:0 8px;margin-bottom:3px;font-size:8.5px;">
    ...
    <!-- F -->
    <div style="margin-bottom:3px;font-size:8.5px;display:flex;align-items:center;gap:5px;flex-wrap:wrap;">
    ...
    <div style="margin-bottom:4px;font-size:8.5px;">
        ...
        <div style="display:flex;gap:12px;margin-top:1.5px;">
    ...
    <div style="border-top:1.5px solid #111;padding-top:2px;margin-bottom:3px;">
        <div style="font-weight:900;font-size:10px;">II. PHYSICAL EXAMINATION</div>
    </div>

    <div style="display:grid;grid-template-columns:52% 48%;gap:0 6px;">
        ...
        <div style="font-size:9px;">
            ...
            <div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid #eee;align-items:center;">
            ...
            <div style="padding:3px 0;font-size:8.5px;">
                <div style="display:flex;justify-content:space-between;">
                    <span style="font-size:9px;">G. Visual Acuity</span>
                ...
                <div style="padding-left:6px;line-height:1.6;">
                    ...
                    <div style="padding-left:66px;">OS <strong>{{ vitals?.visual_acuity_left||'' }}</strong></div>
                    <div>2. Near Vision &nbsp;&nbsp;&nbsp;&nbsp; OD <strong>{{ vitals?.visual_acuity_near_right||'' }}</strong></div>
                    <div style="padding-left:66px;">OS <strong>{{ vitals?.visual_acuity_near_left||'' }}</strong></div>
        ...
        <div>
            <div style="display:flex;gap:5px;margin-bottom:3px;">
                <div style="width:62px;height:75px;border:1px solid #999;flex-shrink:0;overflow:hidden;background:#f5f5f5;display:flex;align-items:center;justify-content:center;">
                ...
                <div style="flex:1;border:1px solid #999;padding:4px;font-size:6.5px;font-style:italic;color:#333;line-height:1.5;">
            ...
            <div style="text-align:center;margin-bottom:3px;">
                <div style="border-top:1px solid #333;display:inline-block;min-width:110px;padding-top:1.5px;font-weight:700;font-size:9px;">
            ...
            <div style="font-size:8.5px;">
                <div style="display:grid;grid-template-columns:11px 80px 1fr;border-bottom:1px solid #333;padding-bottom:1px;margin-bottom:1px;font-weight:700;">
                    <div></div><div>Normal &nbsp; Examination</div><div>P.E. Findings</div>
                </div>
                <div v-for="sys in peSystems" :key="sys.key"
                    style="display:grid;grid-template-columns:11px 80px 1fr;align-items:center;border-bottom:1px solid #f0f0f0;padding:1.5px 0;">
                    <span style="display:inline-flex;align-items:center;justify-content:center;width:9px;height:9px;border:1px solid #333;font-size:7px;"
                ...
                <div style="padding:2px 0;">Other PE Findings</div>
            </div>
        </div>
    </div>
...
<div style="width:210mm;height:297mm;padding:6mm 7mm 8mm;box-sizing:border-box;position:relative;overflow:hidden;">
    ...
    <template v-if="isPE">
            ...
            <div>
                ...
                <table style="width:100%;border-collapse:collapse;font-size:8.5px;">
                    <tr style="border-bottom:1px solid #333;">
                        ...
                        <th style="text-align:left;padding:1px 2px;width:16%;">RESULT</th>
                    ...
                    <tr v-for="row in [
                        ...
                        <td style="padding:3px 2px;">{{ row.name }}</td>
                        <td style="padding:3px 2px;" :style="rs(row.code)">{{ r(row.code) }}</td>
            ...
            <div>
                ...
                <table style="width:100%;border-collapse:collapse;font-size:8.5px;">
                    ...
                    <tr v-for="row in [
                        ...
                        <td style="padding:2.5px 2px;">{{ row.name }}</td>
            ...
            <div>
                ...
                <table style="width:100%;border-collapse:collapse;font-size:8.5px;">
                    <tr v-for="row in [
                        ...
                        <td style="padding:2.5px 2px;width:62%;">{{ row.name }}</td>
                        <td style="padding:2.5px 2px;" :style="rs(row.code)">{{ r(row.code) }}</td>
                    </tr>
                </table>
            </div>
            <div>
                ...
                <table style="width:100%;border-collapse:collapse;font-size:8.5px;margin-bottom:6px;">
                    <tr v-for="row in [
                        ...
                        <td style="padding:3px 2px;width:62%;">{{ row.name }}</td>
                        <td style="padding:3px 2px;" :style="rs(row.code)">{{ r(row.code) }}</td>
                    </tr>
                </table>
                ...
                <table style="width:100%;border-collapse:collapse;font-size:8.5px;">
                    <tr v-for="row in [
                        ...
                        <td style="padding:2.5px 2px;width:65%;">{{ row.name }}</td>
                        <td style="padding:2.5px 2px;" :style="rs(row.code)">{{ r(row.code) }}</td>
                    </tr>
                </table>
            </div>
        ...
        <!-- Lab sigs PE -->
        <div style="display:flex;justify-content:space-between;font-size:9px;border-top:1px solid #aaa;padding-top:4px;margin-bottom:5px;">
            ...
            <div>
                ...
                <table style="width:100%;border-collapse:collapse;font-size:8.5px;">
                    ...
                    <tr v-for="row in [
                        ...
                        <td style="padding:2.5px 2px;">{{ row.name }}</td>
                        <td style="padding:2.5px 2px;text-align:right;" :style="rs(row.code)">{{ r(row.code) }}</td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div>
                ...
                <table style="width:100%;border-collapse:collapse;font-size:8.5px;">
                    <tr v-for="row in [
                        ...
                        <td style="padding:3px 2px;width:55%;">{{ row.name }}</td>
                        <td style="padding:3px 2px;" :style="rs(row.code)">{{ r(row.code) }}</td>
                    </tr>
                </table>
            </div>
